...
<head>
    ...
    <link rel="stylesheet" href="<?= asset_url('/css/errors/404.css') ?>">
    ...
    <div class="container">
        <div class="left-section">
            <div class="inner-content">
                ...
                <p class="subheading">Looks like the page you were looking for is no longer here. <a href='<?= $_ENV['BASEURL'] ?>'>GO HOME</a></p>
            </div>
        </div>
